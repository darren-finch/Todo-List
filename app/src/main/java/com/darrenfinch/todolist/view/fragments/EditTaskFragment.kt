...
class EditTaskFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate<FragmentEditTaskBinding>(
            inflater,
    ...
    private fun setupViewModel() {
        editTaskViewModel = ViewModelProvider(
            viewModelStore,
    ...
    private fun openDatePickerDialog() {
        ...
        context?.let {
            DatePickerDialog(it,
                ...
                calendarForScheduledDate[Calendar.YEAR],
                calendarForScheduledDate[Calendar.MONTH],
                calendarForScheduledDate[Calendar.DAY_OF_MONTH]
            )
        }?.show()
    }
    ...
    private fun openEstimatedTTCPicker() {
        val dialog = PickTimeToCompleteDialog.newInstance(
            editTaskViewModel.observableTask.estimatedTTC,
            editTaskViewModel.observableTask.estimatedTTCUnit
        )
